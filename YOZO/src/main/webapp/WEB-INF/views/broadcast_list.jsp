<%@page import="com.yori.zori.model.dto.BroadcastDto"%>
<%@page import="java.util.List"%>
<%@page import="com.yori.zori.model.dao.BroadcastDao"%>
...
<hr>
   ...
   %>
	...
	<div id="list">
		...
		<input type="button" value="예약하기" id="btn1" onclick="broadcastcheck(<%=year%>, <%=month%>);"/>
...
<style type="text/css">
@import url("resources/css/normal.css");
</style>

<script type="text/javascript" src="resources/js/broadcast_check.js">
</script>
