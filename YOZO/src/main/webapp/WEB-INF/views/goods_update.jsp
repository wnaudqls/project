...
<body>
	<section>
		<form action="<%=request.getContextPath()%>/goods.do" method="post" id="goods_form">
			<input type="hidden" name="command" value="goodsupdateres">
			<input type="hidden" name="goods_no" value="${dto.goods_no}"/>
		<!-- 	<input type="hidden" id="goods_main_photo" name="goods_main_photo"> -->
			<div class="goods_wrap">
				<div class="goods_name">
					<label>상품이름 :</label><input type="text" name="goods_title" required value="${dto.goods_title }"><br> <br> 
					<label>수량 :</label> <input type="number" value="1"	name="goods_quantity" min=1 max=1000 required value="${dto.goods_quantity }"><br> <br> 
					<label>가격:</label> <input type="number" name="goods_price" min=1 required value="${dto.goods_price }"><br><br> 
					<label>이미지 : </label><input id="goods_main_photo" type="file" name="goods_main_photo" onchange="filechange(event)" value="imgtest/${dto.goods_main_photo }"/><br> <br> 
			...
			<div class="goods_etc">
				<hr>
				<div>
					<textarea name="goods_content" id="editor">${dto.goods_content }</textarea>
				<!-- CKEditor -->
					<script type="text/javascript">
